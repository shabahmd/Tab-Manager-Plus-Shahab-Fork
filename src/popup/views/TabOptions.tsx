				...
				<div className="optionsBox">
					...
					<div className="toggle-box">
						<div className="toggle">
							<input
								type="checkbox"
								onMouseEnter={this.props.enterToFocusText}
								onChange={this.props.toggleEnterToFocus}
								checked={this.props.enterToFocus}
								id="enter_to_focus"
								name="enter_to_focus"
							/>
							<label onMouseEnter={this.props.enterToFocusText} htmlFor="enter_to_focus" style={{ whiteSpace: "pre", lineHeight: "2rem" }} />
						</div>
						<label className="textlabel" htmlFor="enter_to_focus" style={{ whiteSpace: "pre", lineHeight: "2rem" }}>
							Enter focuses first match
						</label>
						<div className="option-description">
							After searching, pressing enter will switch to the first matching tab instead of moving all matches to a new window.
							<br />
							<i>By default: disabled</i>
						</div>
					</div>
					<div className="toggle-box">
						<div className="toggle">
							<input
								type="checkbox"
								onMouseEnter={this.props.orderByTabCountText}
								onChange={this.props.toggleOrderByTabCount}
								checked={this.props.orderByTabCount}
								id="order_by_tab_count"
								name="order_by_tab_count"
							/>
							<label onMouseEnter={this.props.orderByTabCountText} htmlFor="order_by_tab_count" style={{ whiteSpace: "pre", lineHeight: "2rem" }} />
						</div>
						<label className="textlabel" htmlFor="order_by_tab_count" style={{ whiteSpace: "pre", lineHeight: "2rem" }}>
							Order windows by tab count
						</label>
						<div className="option-description">
							Windows with the most tabs are shown first.
							<br />
							<i>By default: disabled</i>
						</div>
					</div>
					<div className="toggle-box">
						<div className="toggle">
							<input
								type="checkbox"
								onMouseEnter={this.props.disableResortingText}
								onChange={this.props.toggleDisableResorting}
								checked={this.props.disableResorting}
								id="disable_resorting"
								name="disable_resorting"
							/>
							<label onMouseEnter={this.props.disableResortingText} htmlFor="disable_resorting" style={{ whiteSpace: "pre", lineHeight: "2rem" }} />
						</div>
						<label className="textlabel" htmlFor="disable_resorting" style={{ whiteSpace: "pre", lineHeight: "2rem" }}>
							Disable window re-sorting
						</label>
						<div className="option-description">
							Keep windows in a stable order instead of re-sorting them when their activity changes.
							<br />
							<i>By default: disabled</i>
						</div>
					</div>
				...
				<div className="optionsBox">
					<div className="toggle-box">
						...
						<div className="option-description">
							...
							Enable `Enter focuses first match` above to always switch to the first search match instead.
						</div>
					</div>
				</div>
			</div>
