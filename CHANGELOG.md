...
- When drag and dropping a tab outside of Tab Manager Pro into another program or the browser ( which is not really intended/supported ) it will now paste the URL on drop
